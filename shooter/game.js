...
Game.achievements = {
    'boom':     ['BOOOOOOOOOM!',
                 'Giết 3 chú với 1 quả boom , kinh thật !',
                 10],

    'awesome':  ['AWESOME BOMB, NOT.',
                 'Ngu kinh thiệt , có boom bắn chết mỗi mình >.< .',
                 10],

    'fail':     ['EPIC FAIL!',
                 'Số chó :D . Bắn quá đó làm gì để mảnh nó văng vào người.',
                 9],
    ...
    'master':   ['Master of the Universe',
                 'Ú ù 5 boomb , 5 tên lửa vẫn không xi nhê!',
                 9],

    'guide':    ['Guide to the Galaxy',
                 'Wow có công lắm 42 mạng',
                 8],
    ...
    'hit':      ['Watch out DUUUDE!',
                 'Ờ hớ ăn không một mạng.',
                 6],

    'balls':    ['Balls of Steel',
                 'Có giáp ủn chết 2 cu.',
                 6],
    ...
    'move':     ['Keep Cool...',
                 'Trùm bất động 15 năm không chết !',
                 5],

    'ast':      ['Asteroids. You\'re doing it wrong.',
                 'Bị 5 mãnh thiên thạnh hành .',
                 4],

    'fire':     ['Fireworks!',
                 'Yeah siêu vũ khí đã nổ tiêu diệt .... 0 đối tượng.',
                 4],

    'boost':    ['You\'ve got Boost Power!',
                 'Siêu tay lái (10 giây full speed).',
                 4],

    'bullets':  ['Bullet Proof',
                 'Bắn 5 phát không chết không thể tin nổi .',
                 3],
    ...
    'bad':      ['Bad Luck',
                 'Chết ngay lúc có hàng , sui thế là cùng.',
                 2],

    'hattrick': ['Hattrick',
                 'Giết 3 đứa liền một ván.',
                 2],

    'waste':    ['Space Waste',
                 'Dậy chưa ? chết 6 - 0 rồi kìa.',
                 1],

    'missile':  ['Missile Master',
                 'Trùm đầu cơ vũ khí (10 quả tên lửa).',
                 1],

    'kawaii':   ['Kawaii! ^_^"',
                 'Bắn hết , bắn hết thiên thạch.',
                 1],

    'miss':     ['MISS-iles',
                 'Trùm bắn hụt 5 quả tên lửa :v .',
                 1]
};
