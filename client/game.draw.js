...
Shooter.renderRound = function() {
    ...
    if (this.watching && !this.infoLeftText) {
        $('gameInfoLeft').innerHTML = this.infoLeftText = ' Chơi ngay &lt;canvas&gt;!';
    }
        
    if (!this.roundGO) {
        var text = 'Sẵn sàng trong ' + this.renderTime() + ' | Ván #'
                    + this.roundID + ' kết thúc';
        ...
        var ypos = 60;
        var xpos = 130;
        this.text(xpos, ypos, 'Tên', 'right', 'top');
        this.text(xpos + 70, ypos, 'Điểm', 'right', 'top');
        this.text(xpos + 135, ypos, 'Giết', 'right', 'top');
        this.text(xpos + 195, ypos, 'Chết', 'right', 'top');
        this.text(xpos + 260, ypos, 'Trúng', 'right', 'top');
        ...
        var text = this.renderTime() + ' | Ván #' + this.roundID;
        if (text !== this.infoRightText) {
            $('gameInfoRight').innerHTML = this.infoRightText = text;
